...
import { useDeleteReviewMutation, useGetAllReviewsQuery, useUpdateReviewStatusMutation, useUpdateReviewTrashStatusMutation } from "@/redux/features/review/reviewApi";
...
export default function ManagePage() {
  ...
  const { data, isLoading, isError, isFetching } = useGetAllReviewsQuery(queryParams);
  const [deleteMethod, { isLoading: isDeleting }] = useDeleteReviewMutation();
  const [updateTrash, { isLoading: isUpdatingTrash }] = useUpdateReviewTrashStatusMutation();
  ...
  return (
    <div className="space-y-6">
      <GlobalHeaderSection
        name="Manage Review"
        description="View, edit, and manage all  reviews in the system"
        meta={meta}
              ...
              {isFetching && !isLoading ? (
                ...
                allData?.map(item => (
                  <TableRow key={item._id}>
                    ...
                    <TableCell className="uppercase">{item?.social}</TableCell>
                      ...
                      <DropdownMenu>
                        ...
                        <>
                          <DropdownMenuItem className="cursor-pointer">
                            <Link
                              href={`/dashboard/update-review/${item.slug}`}
