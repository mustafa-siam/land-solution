...
import { useCreatePopupMutation } from "@/redux/features/popup/popupApi";
...
const AddPage = () => {
  ...
  const [handleCreate, { isLoading, error }] = useCreatePopupMutation();
...
//   Object.entries(data).forEach(([key, value]) =>
  ...
  return (
    <div>
      <Heading
        title="Add Popup"
        subTitle="Enter information to add a new Popup to the list."
      />
      <Form {...methods}>
        <form
        ...
        >
          ...
          >
            {isLoading ? "Please Wait..." : "Add Popup"}
          </Button>
