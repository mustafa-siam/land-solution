              ...
              {isFetching && !isLoading ? (
                ...
                allData?.map(item => (
                  <TableRow key={item._id}>
                    ...
                    {/* Updated Inline Dropdown Status Cell */}
                    <TableCell>
                      <Select
                      ...
                      >
                        ...
                        <SelectContent className="bg-white dark:bg-slate-900 border border-gray-200 dark:border-slate-700">
                          <SelectItem value="pending" className="cursor-pointer focus:bg-gray-100 dark:focus:bg-slate-800">
                          ...
                          <SelectItem value="published" className="cursor-pointer focus:bg-gray-100 dark:focus:bg-slate-800">
                    ...
                    <TableCell>
                      <Link href={item.video} className="flex text-blue-600 gap-1 items-center" target="_blank">
                        <Eye size={16} />View
                      </Link>
                    </TableCell>
