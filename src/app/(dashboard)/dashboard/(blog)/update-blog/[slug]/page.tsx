...
import { useGetSingleBlogBySlugQuery, useUpdateBlogMutation } from "@/redux/features/blog/blogApi";
...
const UpdatePage: React.FC<{ params: Promise<ParamsSlug> }> = ({ params }) => {
  ...
  const { data, refetch } = useGetSingleBlogBySlugQuery(slug);
  useEffect(() => {
...
//   Object.entries(data).forEach(([key, value]) =>
    ...
    formData.append("date",metaData?.date); // send as JSON string
  ...
  return (
    <div>
      <Heading
        title="Update Blog"
        subTitle="Edit the details of an existing Blog."
      />
      <Form {...methods}>
        <form
