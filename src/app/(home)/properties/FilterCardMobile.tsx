...
const FilterCardMobile: React.FC<any> = ({ isOpen, filters, setFilters, refetch, setIsOpen }) => {
  ...
  return (
    <div className={`w-80 space-y-5 ${
      isOpen ? "fixed z-50 bg-white top-0 left-0 bottom-0 p-5 overflow-y-scroll" : "hidden"
    }`}>
     <X className="absolute top-2 left-[275px]" onClick={()=>setIsOpen(false)}/>
      {/* Category */}
      ...
      <div className="bg-white space-y-5 rounded">
        ...
        <div className="w-full h-px bg-[#C4C4C4]" />
        {renderSelect("Verification", "verification", { true: "true", false: "false" })}
        {renderSelect("Recommendation", "recommendation", { true: "true", false: "false" })}
      </div>
